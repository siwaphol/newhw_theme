...
<div class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand" href="/"><img src="{{asset('limitless_assets/images/logo_light.png')}}" alt=""></a>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-content width-350">
                    ...
                    <ul class="media-list dropdown-content-body">
                        ...
                        <li class="media">
                            <div class="media-left"><img src="{{asset('limitless_assets/images/placeholder.jpg')}}" class="img-circle img-sm" alt=""></div>
                            <div class="media-body">
                                <a href="#" class="media-heading">
                                ...
                                <ul class="menu-list">
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="../RTL/index.html">RTL version <span class="label bg-danger-400">New</span></a></li>
                                        </ul>
                                    </li>
                                    <li>
