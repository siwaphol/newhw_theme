...
@section('content')
  ...
  <h3 align="center">เลือกกระบวนวิชา</h3>
  <div class="portlet"align="right">
  <div class="portlet-body form"  align="center">
  <form action="homework_assignment/showlist" method="post" name="frmMain" id="frmMain" onsubmit="return onSubmitMain()" class="form-horizontal"  align="center">
  <div class="form-body" >
